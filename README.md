...
```bash
sudo git clone https://github.com/MikaPST/script-install-docker-dockercompose-ubuntu.git && cd script-install-docker-dockercompose-ubuntu/ && sudo chmod +x Script_Install.sh && sudo ./Script_Install.sh && cd .. && sudo rm -r script-install-docker-dockercompose-ubuntu
```
